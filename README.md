...
There used to be a simple way of getting the day list which was to fetch the user's current playlists and iterate until you find the day list. But since [November 27th, 2024](https://developer.spotify.com/blog/2024-11-27-changes-to-the-web-api) Spotify has removed the ability to look up their curated generative playlists across all of their official endpoints.
